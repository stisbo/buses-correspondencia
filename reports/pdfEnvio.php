...
if (!isset($_GET['enid'])) {
  ...
  $tabla .= '<table border="0" cellpadding="0">
            ...
            <tr><td colspan="500" align="left"><b>Fecha estimada llegada: </b>' . $fechaEstimada . '</td></tr>
            <tr><td colspan="500" align="center" style="padding: 8px; text-align: left; border-bottom: 1px solid #000;"></td></tr></table>';
  ...
  $tabla .= '<tr><td colspan="200" align="center" style="padding: 8px; text-align: center;">Firma/Sello Emp. Bolivar</td><td colspan="100"></td><td colspan="200" align="center" style="padding: 8px; text-align: center;">Firma remitente</td></tr>';
  $tabla .= '</table>';
